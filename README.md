<p align="center">
<img width="860" height="625" alt="image" src="https://github.com/user-attachments/assets/9ef6a7e9-c54a-4c2a-95f9-d177e497bf6b" />
</p>
...
The first portion of this will be Setting up the remote desktop for non-administrative users on Client-1 
...
<p>
Once you are logged in we are going to open system properties. 
...
<p>
In the "Enter the object names to select" text box type domain users and click "Ceheck Names". Then click "OK".
<p>
...
<p>
Now we are going to use power shell to create multiple users inside active directory. 
...
<p>
In Apps right click "Windows Powershell ISE" and clcik "Run as administrator". 
<p>
...
<p>
Log into client-1 and put in mydomain.com\user you chose. 
...
<p>
Go to "This PC" and click the C drive. 
<p>
...
<p>
Now we are going to go through the process of changes a users password after too many log in attempts. 
...
<p>
CLick the Drop arrow for Windows Settings > Security Settings then click "Account policies". 
...
<p>
Check the box for Define this policy setting. Then change the Account is locked out for: to 30 minutes and click "OK". 
<p>
...
<p>
Click "Find Now" and after it refresshes the little down arrow will be gone and this user will be active again. 
<p>
<img <img width="1440" alt="CPS_83" src="https://github.com/user-attachments/assets/75b002b5-937d-4869-984b-401d9825f31c" />
</p>
<p>
Now we are going to go back to client-1 to verify that the account is active. 
...
<p>
With the account reactivated you will be signed back into client-1.
<p>
<img <img width="1440" alt="CPS_85" src="https://github.com/user-attachments/assets/2a3b68ce-40d7-4267-9541-ea6311261bbf" />
</p>
<p>
Lastly we are going to go through the steps to check and observe the logs in the Domain Controller. 
...
<p>
On the left expand Windows logs rhen click "Security". 
<p>
<img <img width="1440" alt="CPS_87" src="https://github.com/user-attachments/assets/2fc1eb44-72b9-4d13-8230-b18039c6647c" />
</p>
<p>
There are alot of events to go through so we are going to search for specific ones. 
